...
public partial class index : System.Web.UI.Page
{
    ...
    private void RedirectBasedOnNTNameLookup(string myID)
    {
        ...
        if (myID != "IDNotFound")
        {
           // myID = "gsing017"; // ssawa015 atike001 Pdsou014 vchoh001 mchau006 ykand001// RTA Vinod Chauhan sbodh001 vfern016  fjaya001 smerc021  vpere018 Pdsou014  nrodr058  mshai066
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    Session["dtEmp"] = dt;
                    Response.Redirect("leave.aspx", false);
                }
                else
                {
