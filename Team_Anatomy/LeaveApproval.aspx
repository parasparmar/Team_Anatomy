                ...
                <div class="box-body">
                    <div class="row">
                        <asp:Panel CssClass="col-md-12" ID="pnlAmIRvwMgr" Visible="true" runat="server">
                            ...
                            <div class="col-md-2">
                                <label id="lblLevel1Filter" for="ddlLevel1Filter" aria-label="Filter L1">Filter: L1</label>
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <label id="lblLevel2Filter" for="ddlLevel2Filter" aria-label="Filter: L2">Filter: L2</label>
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnReset" CssClass="btn btn-warning" runat="server" Text="Reset" OnClick="btnReset_Click" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label for="btnDownloadFilteredData" aria-label="Download Filtered Data">Download Filtered Data</label>
                                <div class="form-group">
                                    <asp:LinkButton ID="btnDownloadFilteredData" CssClass="btn" runat="server" Text="Download Excel" OnClick="btnDownloadFilteredData_Click">
                                    <img src="Sitel/img/excel.png" height="50px" /></asp:LinkButton>
                                </div>
                            </div>
                            <!-- ddlRepManager-->
